...
## weight to be assigned to the loss from image at timestep t, from the last layer of U-net. // The weight for the image at timestep t/2 will be 1-weight1
HYPER_PARAMS = {'loss_weight' : 0.7}
...
def train(search_params):
  ...
  for epoch in tqdm_epoch:
    ...
    torch.save(score_model.state_dict(), '/home/harsh/Desktop/SDE/checkpoints/nov10th/trial.pth')
